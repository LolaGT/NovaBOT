...
module.exports = {
    ...
    execute(client, message, args) {
      ...
      const embed = new MessageEmbed()
        ...
        .setImage(`https://some-random-api.ml/canvas/youtube-comment?avatar=${message.author.displayAvatarURL({format: 'png', size:1024})}&username=${message.member.displayName}&comment=${msg.join('')}`)
        .setTimestamp()
